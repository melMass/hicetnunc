...
import { uploadMetadataFile, prepareFile, prepareFile100MB, prepareDirectory } from '../../data/ipfs'
...
export const MelMint = () => {
  ...
  const handleMint = async () => {
    if (!acc) {
      ...
      //   })
      // }
      nftCid = await uploadMetadataFile({
        name: title,
        description,
        tags,
        cid: `ipfs://${objktCID}`,
        ...
        <>
          <Container>
            <Padding>
              ...
              <Input
                type="text"
                onChange={(e) => setObjktCID(e.target.value)}
                placeholder="ipfs://"
                label="IPFS CID for the OBJKT"
                value={objktCID}
              />
              <Input
                type="text"
                ...
                placeholder=""
                label="IPFS CID for the CoverImage"
                value={coverCID}
              />
              <Input
                type="text"
